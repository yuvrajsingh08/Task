...
function AiAssistantPage() {
  ...
  return (
    <>
      ...
      <section className="rounded-2xl border border-orange-100 bg-white p-4 shadow-sm shadow-orange-100/60 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none sm:p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-400 to-pink-500 text-white">
              <Sparkles size={20} />
            </div>
            <div>
      ...
      <section className="mt-4 rounded-2xl border border-orange-100 bg-white p-4 shadow-sm shadow-orange-100/60 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none sm:p-5">
